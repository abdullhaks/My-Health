...
//     constructor(
//         @inject("IAdminAppointmentService") AdminAppointmentService: IAdminAppointmentService
//     ) {
...
//   const appointments = await this._appointmentService.getAppointments(pageNumber, limitNumber);
